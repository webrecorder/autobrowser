(() => {
  ...
  // rest is in order to resist bot fingerprinting https://bot.sannysoft.com/
  ...
  if (!window.chrome.runtime) {
    const runtime = {
      ...
      connect(id, info) {
        const sig = 'runtime.connect(optional string extensionId, optional object connectInfo)';
        if (!id) {
          throw new TypeError(
      ...
      sendMessage(id, msg, opts) {
        const sig = 'runtime.sendMessage(optional string extensionId, any message, optional object options, optional function responseCallback)';
